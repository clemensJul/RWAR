...
import { Search, Loader2, Droplets, Mountain, Flame, Sun } from 'lucide-react';
...
const ICON_MAP = { Droplets, Mountain, Flame, Sun } as const;
...
function Dashboard() {
  ...
  return (
    <div className="flex flex-col h-screen overflow-hidden" style={{ background: '#f4f0e8' }}>
      ...
      {/* ── TOPBAR ── */}
      <header
        className="flex items-center gap-4 px-5 flex-shrink-0 z-10"
